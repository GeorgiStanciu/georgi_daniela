...
public class ViewAllOrders extends BaseActivity {
    ...
    protected void addLayout() {
        ...
        view = inflater.inflate(R.layout.activity_view_all_orders,null);
        ...
        if(orders == null || orders.size() == 0){
            ...
            orderButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(ViewAllOrders.this, MainActivity.class);
    ...
    class GetOrders extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            CommandResponse response = client.receiveDataFromServer(new Command(CommandEnum.ViewOrderesCommand));
